...
class TestTelegramNotifier(unittest.TestCase):
    ...
    def test_escape_markdown_v2(self):
        ...
        expected = r"Test with \_ \* \[ \] \( \) \~ \` \> \# \+ \- \= \| \{ \} \. \! special characters"
    ...
    def test_format_listing_message_with_special_chars_in_link(self):
        ...
        listing = Listing(
            ...
            link='https://www.wbm.de/wohnungen-berlin/angebote/details/?tx_openimmo_immobilie[immobilie]=60-7903/24/366',
        ...
        expected_message = (
            f"🏠 *New Listing*\n\n"
            "📍 *Address:* [Goltzstrasse 47, 13587 Berlin](https://www.google.com/maps/search/?api=1&query=Goltzstrasse%2047%2C%2013587%20Berlin)\n"
            ...
            "🔗 Details: https://www\.wbm\.de/wohnungen\-berlin/angebote/details/?tx\_openimmo\_immobilie\[immobilie\]\=60\-7903/24/366"
        )

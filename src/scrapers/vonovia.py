...
listings from vonovia.de via their internal API.
...
class VonoviaScraper(BaseScraper):
    ...
    Uses the Vonovia internal API to fetch Berlin apartment listings.
    """
    ...
    def __init__(self, name: str):
        ...
        """
        super().__init__(name)
        self.api_url = "https://www.vonovia.de/api/real-estate/list"
        self.base_url = "https://www.vonovia.de"
        self.headers.update(
            {
    ...
    def _build_listing_url(self, listing_data: dict) -> str:
        ...
        slug = listing_data.get("slug", "")
        if slug:
            return f"{self.base_url}/zuhause-finden/{slug}"
